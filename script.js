...
function updateUser(id) {
    ...
    axios.put("https://mongodb2111.herokuapp.com/users", {
        name,
        email,
        address
    }).then(() => {
...
function deleteUser(id) {
    ...
    axios.delete(`https://mongodb2111.herokuapp.com/users`).then((e) => {
        // getPost()
        document.getElementById('alertcontainer').innerHTML = `<div class="alert alert-success" role="alert">
            User Are Deleted!!!
            </div>`
...
form.addEventListener('submit', (e) => {
    ...
    axios.post("https://mongodb2111.herokuapp.com/users", {
        name: userName,
        email: userEmail,
        address: userAddress,
