...
let users;
function getPost() {
    axios.get('https://mongodb2111.herokuapp.com/users').then(responce => {
...
function updateUser(id) {
    ...
    axios.put(`https://mongodb2111.herokuapp.com/user/${id}`, {
        name,
        email,
        address
    }).then(() => {
...
function deleteUser(id) {
    ...
    axios.delete(`https://mongodb2111.herokuapp.com/user/${id}`).then((e) => {
        // getPost()
        document.getElementById('alertcontainer').innerHTML = `<div class="alert alert-success" role="alert">
            User Are Deleted!!!
            </div>`
...
form.addEventListener('submit', (e) => {
    ...
    axios.post('https://mongodb2111.herokuapp.com/user', {
        name: userName,
        email: userEmail,
        address: userAddress,
    }).then(() => {
